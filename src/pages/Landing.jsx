...
const Landing = () => {
  return (
    <div className="min-h-screen bg-paper text-ink font-sans selection:bg-neo-yellow selection:text-ink">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-paper/80 backdrop-blur-md border-b-2 border-ink px-3 sm:px-6 py-3 sm:py-4 flex justify-between items-center shadow-[0_2px_0px_#121212]">
      ...
      {/* Hero Section */}
      <header className="pt-20 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        <motion.div
        ...
        >
          ...
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-black leading-none tracking-tighter uppercase italic mb-8\">
      ...
      {/* Features */}
      <section className="py-16 sm:py-40 px-4 sm:px-6 max-w-7xl mx-auto">
