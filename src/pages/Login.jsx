  ...
  return (
    <div className="min-h-screen bg-paper flex items-center justify-center p-6 auth-container relative">
      ...
      >
        ...
        <h2 className="text-3xl font-black text-center mb-2 tracking-tighter text-ink uppercase italic">Login</h2>
        <p className="text-ink/60 text-center mb-10 font-serif italic text-base border-b-2 border-ink/10 pb-3">
          "Please enter your master password to access your vault."
        </p>
        ...
        <p className="mt-10 text-center text-ink font-serif italic text-base">
          New user? <Link to="/register" className="text-neo-blue font-black uppercase hover:underline underline-offset-4 decoration-2 not-italic">Create Account</Link>
        </p>
      </motion.div>
    </div>
  );
